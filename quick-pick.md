...
**Tab** emulates holding **Alt + Ctrl**, allowing multiple objects to be selected without holding the keys. The **Toggle Mode** key can be changed in the plugin settings.
